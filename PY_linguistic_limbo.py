...
"""
Created on Thu Mar 27 18:14:09 2025
...
df_countries = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/countries_codes_and_coordinates_(clean).csv')
...
df_lang_atlas = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/language_atlas_(clean).csv')
...
df_endangeredlangs = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/endangered_langs_dataset_(clean).csv')    
...
df_lang_atlas.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_atlas.csv', index = False)
df_endangeredlangs.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_endangered.csv', index = False)
languages.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_lanugages.csv', index = False)


# re-importing datasets (as to not re-create from scratch)
import pandas as pd

atlas = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_atlas.csv')
endangered = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_endangered.csv')
languages = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/FINAL_lanugages.csv')
...
df_Eurasia = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/Languages_Eurasia.csv')
df_Papunesia = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/Languages_Papunesia.csv')
df_Africa = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/Languages_Africa.csv')
...
# export all as CSV      
bycountry_Eurasia.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/bycountry_Eurasia.csv', index = False)
bycountry_Papunesia.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/bycountry_Papunesia.csv', index = False)
bycountry_Africa.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/bycountry_Africa.csv', index = False)


# import modified sheet of Brazil's endangered languages and shift points to first quarter
import pandas as pd

brazil_endangered = pd.read_csv('/Users/tomragus/Desktop/Languages Project/Datasets/Spread Brazil (endangered).csv')
...
df_centroids.to_csv('/Users/tomragus/Desktop/Languages Project/Datasets/centroids.csv', index = False)
